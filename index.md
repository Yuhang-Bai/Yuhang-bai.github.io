...
1. **Yuhang Bai**, Kristóf Bérczi, Gergely Csáji, Tamás Schwarcz. [Approximating maximum-size properly colored forests](https://arxiv.org/abs/2402.00834). *Journal*.
2. Yichen Wang, Zixuan Yang, Xiamiao Zhao, **Yuhang Bai**, Junpeng Zhou. [The Turán number of Berge matchings](https://arxiv.org/abs/2510.05422). *Journal*.
3. **Yuhang Bai**, Kristóf Bérczi, Johanna K. Siemelink. [Approximating maximum properly colored forests via degree bounded independent sets](https://arxiv.org/abs/2511.18263). *Journal*.
4. **Yuhang Bai**, Gyula O.H. Katona, Zixuan Yang. [Most probably trangle-free graphs](https://arxiv.org/abs/2602.22782). *Journal*.


### Journal

1. **Yuhang Bai**, Zhiwei Guo, Shenggui Zhang, Yandong Bai. [Linear amortized time enumeration algorithms for compatible Euler trails in edge-colored graphs](https://link.springer.com/article/10.1007/s10878-023-01005-w). *Journal of Combinatorial Optimization*, 45, 73.
...
3. **Yuhang Bai**, Shenggui Zhang, Yandong Bai, Jianhua Tu. The parameterized complexity of properly colored spanning trees problem. *Journal*. *Submitted*.
   <details>
...
5. **Yuhang Bai**, Shenggui Zhang. Properly colored thresholds. *Journal*. *Submitted*.
   <details>
       <summary>Abstract</summary>
       <blockquote>
...
6. Yichen Wang, Zixuan Yang, Xiamiao Zhao, **Yuhang Bai**, Junpeng Zhou. The Turán number of Berge matchings. *Journal*. *Submitted*.
7. **Yuhang Bai**, Kristóf Bérczi, Johanna K. Siemelink. Approximating maximum properly colored forests via degree bounded independent sets. *Journal*. *Submitted*.
